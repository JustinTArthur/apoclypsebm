...
// ?: modified in Phoenix project
// ?: Upstreamed to poclbm
// 2011-07-11: further modified by Diapolo and still public-domain
// 2020-05: AMD GCN assembly optimizations by Justin Arthur
...
__constant ulong L = 0x198c7e2a2;
  ...
  #define Ch(x, y, z) ({ \
    ...
    __asm__ __volatile__( \
      "V_BFI_B32 %0 %2 %3 %4\n\t" \
      "V_BFI_B32 %1 %5 %6 %7" \
      : "=v" (result.s0), "=v" (result.s1) \
      : "v" (x.s0), "v" (y.s0), "v" (z.s0), "v" (x.s1), "v" (y.s1), "v" (z.s1) \
    ); \
    result; \
  })
#else
...
#endif
// Ma now uses the Ch function, with v_bfi_b32, the optimized Ch version is used
